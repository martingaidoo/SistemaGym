...
def reproducir_sonido(value):
    ...
    pygame.mixer.init()
    if value == "pago":
        sonido = pygame.mixer.Sound(r"C:\Users\Usuario\Downloads\SistemaGym-main(6)\SistemaGym-main\sonidobien.wav")
        sonido.play()
    else:
        sonido = pygame.mixer.Sound(r"C:\Users\Usuario\Downloads\SistemaGym-main(6)\SistemaGym-main\sonidomal.mp3")
        sonido.play()
